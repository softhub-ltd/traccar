...
public class H02ProtocolDecoderTest extends ProtocolTest {
    ...
    @Test
    public void shouldContainTempAndHumid() throws  Exception {
    ...
    public void shouldContainTempHumidityBattery() throws  Exception {
        ...
        H02FrameDecoder frameDecoder = new H02FrameDecoder(0);
        H02ProtocolDecoder decoder = new H02ProtocolDecoder(null);
        ...
        // ByteBuf protocolMessage = binary(    "2498050059241130181504202928066606106282618c000000bffffbffff0013000000000001cc00ff640000000000e6023907");
        ByteBuf newBufMessage = (ByteBuf)frameDecoder.decode(null, null, protocolMessage);

        Position position = (Position) decoder.decode(null, null, newBufMessage);
